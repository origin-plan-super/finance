    ...
    <form class="layui-form" style="width: 600px;" action="" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input lay-verify='required' type="text" name="exam_name" placeholder="请输入考试名称" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <!-- 注意：这一层元素并不是必须的 -->
                <input lay-verify='required' type="text" name="exam_date" class="layui-input" id="date" placeholder="请选择日期">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input lay-verify='required' type="text" name="exam_time" class="layui-input" id="time_start" placeholder="开始时间">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input lay-verify='required' type="number" name="exam_num" placeholder="考位数量" autocomplete="off" class="layui-input">
            </div>
        </div>
        <!--  -->
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input lay-verify='required' type="number" name="exam_money" placeholder="考试价格" autocomplete="off" class="layui-input">
            </div>
        </div>
        <!--  -->
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <textarea lay-verify='required' name="exam_subject" rows='10' placeholder="请输入科目" class="layui-textarea"></textarea>
            </div>
        </div>
