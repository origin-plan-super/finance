    ...
    <script>
        ...
        layui.use(['table', 'form'], function () {
            ...
            tableIns = table.render({
                id: 'table'
                , elem: '#table'
                , url: '/finance/index.php/Admin/DiscountSubject/getList' //数据接口
                , page: true //开启分页
            ...
            table.on('tool(table_filter)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                ...
                if (layEvent === 'del') { //删除
                    ...
                    layer.confirm('真的删除此条数据吗？', function (index) {
                        ...
                        $.post('/finance/index.php/Admin/DiscountSubject/del', {
        ...
        */
        ...
        $('#add').on('click', function () {
            layer.open({
                ...
                area: ['893px', '600px'],
                content: '/finance/index.php/Admin/DiscountSubject/add'
        ...
        $(document).on('click', '#removeAll', function () {
            ...
            layer.confirm('确定删除这些商品？', function (index) {
                ...
                $.post('/finance/index.php/Admin/DiscountSubject/removes', {
        ...
        function saveInfo(post, f) {
            $.post('<?php echo U("DiscountSubject/saveInfo");?>', post, function (res) {
                console.log(res);
                res = JSON.parse(res);
                if (f != null) {
                    f(res);
